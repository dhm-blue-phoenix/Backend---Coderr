...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "title", "price", "revisions", "delivery_time_in_days", "features", "offer_type", "customer_user", "business_user", "created_at", "updated_at"]
    ...
    def create(self, validated_data):
        ...
        if customer.type == 'business':
            raise serializers.ValidationError('Business-Benutzer können keine Bestellungen aufgeben.')
